...
public class ExcelRead2007 {


public static void main( String [] args ) {

String fileName="C:\\Bulk_Upload_Facility.xlsm";
...
XSSFWorkbook myXWorkBook = new XSSFWorkbook(myInput);

 /** Get the first sheet from workbook**/
XSSFSheet mySheet = myXWorkBook.getSheetAt(0);
